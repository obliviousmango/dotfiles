...
spotify_widget:connect_signal("button::press", function(_, _, _, button)
    if (button == 2) then awful.spawn("sp play", false)      -- middle click
    elseif (button == 3) then awful.spawn("sp next", false)  -- right  click
    elseif (button == 1) then awful.spawn("sp prev", false)  -- left click
    end
