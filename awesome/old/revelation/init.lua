...
local revelation = {
    ...
    curr_tag_only = false,
    font = "Meslo LG S 28",
    fg = beautiful.fg_normal or "#a0a0a0",
    bg = beautiful.bg_normal or "#282c34",
    border_color=beautiful.border_focus or "#888888",
    border_width=beautiful.border_width or 3,
    hintsize = (type(beautiful.xresources) == 'table' and beautiful.xresources.apply_dpi(40) or 50)
}
