...
-- {{{ Taglist
theme.taglist_fg_empty = "#2e343f"
theme.taglist_fg_focus = theme.fg_normal 
--theme.taglist_bg_focus = "#484f5d"
theme.taglist_fg_occupied = theme.fg_normal
--theme.taglist_font = "FontAwesome bold 13"
theme.taglist_font = "Roboto medium 12"
-- }}}

-- {{{ Tasklist
theme.tasklist_fg_focus = theme.fg_normal
theme.tasklist_fg_normal = "#3e444f"
...
-- {{{ Notifications
-- }}}
theme.notification_border_color = theme.fg_nonfoc	 
